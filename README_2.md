...
### [AMICAL](https://github.com/SAIL-Labs/AMICAL) — Aperture Masking Interferometry Calibration & Analysis Library
...
### [MATISSE-py](https://github.com/Matisse-Consortium/matisse-pipeline) — Modern Python interface for the VLTI/MATISSE pipeline
...
**Also authored:**
- **[PREVIS](https://github.com/DrSoulain/PREVIS)** — tool to predict the observability of a target with the VLTI and CHARA arrays, from its coordinates and magnitudes
- **[gravi_align](https://github.com/DrSoulain/gravi_align)** — corrects the spectral effects introduced by GRAVITY's former prism (VLTI/GRAVITY)

---

## ⚙️ Tech stack

**Languages** Python (10+ yrs) · bash · LaTeX
**Data & ML** NumPy · SciPy · pandas · scikit-learn (Isolation Forest, K-Means, Bayesian Optimisation) · Seaborn · Matplotlib · statistical model fitting · signal & image processing
**Engineering** open-source packaging · pytest · CI/CD · semantic versioning · typing/mypy · Commitizen · documentation
**Domains** large observational dataset · time-series · data reduction pipeline · optical/IR interferometry · high-angular-resolution imaging

---

## 📫 Connect

- ✉️ anthony.soulain@protonmail.com
- 🏛️ [Université Côte d'Azur — profile](https://univ-cotedazur.fr/anthony-soulain)
- 🔬 [Refereed publications (NASA/ADS)](https://ui.adsabs.harvard.edu/public-libraries/B40533jhThiIg5Zmics3pg)
